function [methodinfo,structs,enuminfo,ThunkLibName]=usbdrdaqMFile_win32
%USBDRDAQMFILE_WIN32 Create structures to define interfaces found in 'usbDrDaqApi'.

%This function was generated by loadlibrary.m parser version  on Thu Jun 15 11:51:25 2017
%perl options:'usbDrDaqApi.i -outfile=usbdrdaqMFile_win32.m'
...
% PICO_STATUS _stdcall UsbDrDaqPhTemperatureCompensation ( int16_t handle , int16_t enabled ); 
fcns.name{fcnNum}='UsbDrDaqPhTemperatureCompensation'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'int16'};fcnNum=fcnNum+1;
